<div class="relative mt-10 py-16 bg-white">
        ...
        <div class="lg:grid lg:grid-cols-12">
            ...
            <div class="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
                ...
                <div class="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
                    <div class="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                        <img class="object-cover bg-white p-10 object-center rounded-3xl shadow-2xl" src="https://github.com/LLoadout/assets/blob/master/LLoadout_brands.png?raw=true" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="relative bg-blue-400 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div class="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                    <h2 class="text-3xl font-extrabold text-white" id="join-heading">Want to learn more from LLoadout ?</h2>
                    <p class="text-lg text-white">LLoadout is your loadout for Laravel, helping you kickstart your development process. Besides this refactoring site we also make some cool packages and video tutorials !</p>
                    <a class="block w-full py-3 p-5 text-center bg-white border border-transparent rounded-md shadow-md text-base font-medium text-indigo-700 hover:bg-gray-50 sm:inline-block sm:w-auto" target="_blank" href="https://github.com/LLoadout">Go to LLoadout on github</a>
                </div>
            </div>
        </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-194448073-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-194448073-1');
</script>
