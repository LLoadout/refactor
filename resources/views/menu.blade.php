        ...
        <div class="relative flex justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0 flex items-center mt-5">
                    <img class="block lg:hidden h-8 w-auto" src="{{ asset('img/headerlogo.png') }}" alt="Workflow">
                    <img class="hidden lg:block h-8 w-auto" src="{{ asset('img/headerlogo.png') }}" alt="Workflow">
                </div>
